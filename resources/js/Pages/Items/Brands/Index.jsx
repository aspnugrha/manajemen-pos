...
const Index = ({ data }) => {
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="btn-group">
                    <Link
                        href={`/A/manage-item-brands/${row.id}/edit`}
    ...
    const hapusData = (id, enabled) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.post(`/A/manage-item-brands/active-nonactive`, {
                    id,
                    enabled,
                });
            }
    ...
    return (
        <>
            <Head>
                <title>Item Brands | Manajemen POS</title>
            </Head>
            <DefaultAdmin>
                <div className="w-100">
                    <div className="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                        <div className="flex justify-between mb-2 items-start">
                            ...
                            <div className="btn-group">
                                <Link
                                    href={`/A/manage-item-brands/create`}
